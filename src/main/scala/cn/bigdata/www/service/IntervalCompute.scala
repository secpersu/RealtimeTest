...
import cn.bigdata.www.metric.impl.{ComputeIntervalSum, DistinctCountString,ComputeIntervalCount,ComputeIntervalFloatMax,ComputeIntervalFloatMin}
import cn.bigdata.www.metric.impl.{ComputeIntervalFloatMedian,ComputeIntervalFloatStd}
